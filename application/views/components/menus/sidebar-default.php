<ul class="nav" id="side-menu">
    ...
    <li class="page-id-home">
        <a href="<?php echo base_url('home'); ?>"><i class="fa fa-home fa-fw"></i> <?php echo lang('Home'); ?><i class="fa arrow fa-fw"></i></a>
        <ul class="nav nav-second-level">
            <li>
                <a href="#"><i class="fa fa-desktop fa-fw"></i> <?php echo lang('Reporting'); ?><i class="fa arrow fa-fw"></i></a>

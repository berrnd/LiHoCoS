...
if (!defined('SECRET_ACCESS_TOKEN'))
    define('SECRET_ACCESS_TOKEN', 'z3byakR7fG6lgzlcS3j2cT35y');
...
if (!defined('TARGET_DIR'))
    define('TARGET_DIR', '/var/www/demo.lihocos.de/stable');
...
<script>
    window.onload = function() {
        window.open("http://demo.lihocos.de/stable/install", "_blank");
    }
</script>